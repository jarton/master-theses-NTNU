...
\include{inc/related} % could be called Methodology or methods or any filename 
\include{inc/collection} % could be results
\include{inc/analysis}
\include{inc/clustering}
